...
func (m *associate) handleIssueEvent(e *sdk.IssueEvent, log *logrus.Entry) error {
	if e == nil {
...
func (m *associate) handleNoteEvent(e *sdk.NoteEvent, log *logrus.Entry) error {
	if e == nil {
		return fmt.Errorf("event payload is nil")
	}
...
func (m *associate) handlePREvent(e *sdk.PullRequestEvent, log *logrus.Entry) error {
	if e == nil {
		return fmt.Errorf("pr event payload is nil")
	}
	if *(e.Action) == "open" {
